                                        ...
                                        <table role="presentation" cellpadding="0" cellspacing="0" border="0" style="background-color: ##f5f5f5; border: 2px solid ##e0e0e0; border-radius: 8px;">
                                            <tr>
                                                <td style="padding: 24px 48px;">
                                                    <p style="margin: 0; color: ##212121; font-size: 36px; font-weight: 700; letter-spacing: 8px; font-family: 'Courier New', Courier, monospace; text-align: center;">#args.code#</p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
